...
class SalesHoldScreen extends StatefulWidget {
  const SalesHoldScreen({super.key});

  @override
  State<SalesHoldScreen> createState() => _SalesHoldScreenState();
}

class _SalesHoldScreenState extends State<SalesHoldScreen> {
  List listOfColumns = [
    {
      'index': "1",
      'date': "02-03-2023",
