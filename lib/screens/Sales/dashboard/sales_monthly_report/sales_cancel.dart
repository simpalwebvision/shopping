...
class SalesCancelScreen extends StatefulWidget {
  const SalesCancelScreen({super.key});

  @override
  State<SalesCancelScreen> createState() => _SalesCancelScreenState();
}

class _SalesCancelScreenState extends State<SalesCancelScreen> {
  List listOfColumns = [
    {
      'index': "1",
      'date': "02-03-2023",
