...
import '../../../../../widgets/common_signature_pad.dart';

class SalesPendingProceed extends StatefulWidget {
  const SalesPendingProceed({super.key});

  @override
  State<SalesPendingProceed> createState() => _SalesPendingProceedState();
}

class _SalesPendingProceedState extends State<SalesPendingProceed> {
