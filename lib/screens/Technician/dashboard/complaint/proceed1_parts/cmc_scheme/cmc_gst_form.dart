...
class CMCGSTFormPage extends StatefulWidget {
  final ByteData byteList;
  final double totalAmount;

  final List<AddPartModel> finallist;
  const CMCGSTFormPage(
      {super.key,
  ...
  @override
  State<CMCGSTFormPage> createState() => _CMCGSTFormPageState();
}

class _CMCGSTFormPageState extends State<CMCGSTFormPage> {
