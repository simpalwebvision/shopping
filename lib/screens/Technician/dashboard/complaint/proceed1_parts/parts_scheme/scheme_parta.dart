...
import 'package:shopping/screens/Technician/dashboard/complaint/proceed1_parts/parts_scheme/part_form.dart';
import 'package:shopping/screens/Technician/dashboard/complaint/proceed1_parts/parts_scheme/parts_provider.dart';
...
class SchemePartScreen extends StatefulWidget {
  const SchemePartScreen({super.key});

  @override
  State<SchemePartScreen> createState() => _SchemePartScreenState();
}

class _SchemePartScreenState extends State<SchemePartScreen> {
  String? selectedval = '';
    ...
    return Scaffold(
        ...
        body: Stack(
          children: [
            ...
            _buildPartWidget(size)
          ],
        ));
  }

  Widget _buildPartWidget(Size size) {
    ...
    return SingleChildScrollView(
        child: Padding(
            ...
            child: Column(
              children: [
                partsProvider.finallist.isEmpty
                    ? Container()
                    : Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            ListView.builder(
                                ...
                                itemCount: partsProvider.finallist.length,
                                controller: _scrollController,
                                shrinkWrap: true,
                                itemBuilder: (context, index) {
                                  var quan = double.parse(partsProvider
                                      .finallist[index].quantity
                                      .toString());
                                  var price = double.parse(partsProvider
                                  ...
                                  return Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        Text(
                                          '${index + 1})   ${partsProvider.finallist[index].pname.toString()}',
                                          style: TextStyle(
                                        ...
                                        const Spacer(),
                                        Text(
                                          '${partsProvider.finallist[index].price.toString()}  x  ${partsProvider.finallist[index].quantity.toString()}',
                                          style: TextStyle(
                                              fontWeight: FontWeight.w500,
                                              fontSize: size.width * 0.034),
                                        ),
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        partsProvider.total.toStringAsFixed(2),
                                        style: TextStyle(
                                            fontWeight: FontWeight.w500,
                                            fontSize: size.width * 0.034),
                                      )
                                    ...
                                    children: [
                                      ...
                                      AddRemoveRateButtons(
                                        ...
                                        onSubtractButtonClick: () {
                                          partsProvider.onSubtractButtonClick(
                                              selectedval);
                                        },
                                      ),
                                      const SizedBox(
                                      ...
                                      children: [
                                        ...
                                        AppAddPartButtonWidget(
                                            onTap: () {
                                              ...
                                              partsProvider.addPartsFunction(
                                                fromAddParts: false,
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: CupertinoSlidingSegmentedControl(
                            ...
                            groupValue: partsProvider.sliding,
                            onValueChanged: (int? newValue) {
                              CommonFunctions.hideKeyboard(context);
                              partsProvider.changeSlidingPosition(newValue);
                            },
                          ),
                        ),
                        const SizedBox(
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              else if (partsProvider.sliding == 1)
                                StepperTextField(
                                  rOnly: false,
                              ...
                              else if (partsProvider.sliding == 2)
                                Column(
                                  children: [
                                    Container(
                                      padding: const EdgeInsets.symmetric(
                                    ...
                                    ListView.builder(
                                        ...
                                        itemCount:
                                            partsProvider.chequeList.length,
                                        controller: _scrollController,
                                        shrinkWrap: true,
                                        itemBuilder: (context, index) {
                                          return Container(
                                                          ...
                                                          border: Border(
                                                              right: BorderSide(
                                                                  color:
                                                                      primaryColor))),
                                                      child: Text(
                                                        '${partsProvider.chequeList[index].checkAmount.toString()} \u{20B9}',
                                                        textAlign:
                                                            TextAlign.center,
                                                        style: TextStyle(
                                                            fontWeight:
                                                          ...
                                                          children: [
                                                            ...
                                                            AppAddPartButtonWidget(
                                                                onTap: () {
                                                                  ...
                                                                  partsProvider.addChequeFunction(
                                                                      chequeD:
                                                                          _ctlChequeDate
                                                                              .text,
                                                                      chequeNumb:
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: InkWell(
                      onTap: () {
                        partsProvider.navigateToSignaturePad(
                            context, partsProvider);
                      },
                      child: Container(
                        ...
                        child: partsProvider.bytes == null
                            ? Row(
                            ...
                            : Image.memory(
                                partsProvider.bytes!.buffer.asUint8List()),
                      ),
                    ),
                  ),
                ),
                ...
                AppButtonWidget(
                  onTap: () {
                    if (partsProvider.bytes != null) {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => PartFormPage(
                                    byteList: partsProvider.bytes,
                                    finallist: partsProvider.finallist,
                                  )));
                    } else {
