...
class AMCFormPage extends StatefulWidget {
  ...
  @override
  State<AMCFormPage> createState() => _CMCFormPageState();
}

class _CMCFormPageState extends State<AMCFormPage> {
                      ...
                      child: Column(
                        children: [
                          ...
                          const SmallTermsAndConditionWidget(
                              ...
                              iconColor: Colors.black,
                              text:
                                  'Only one year warranty in new spare part.'),
                          SizedBox(height: size.height * 0.01),
                          const SmallTermsAndConditionWidget(
                              initialText: '5.',
                              iconColor: Colors.black,
