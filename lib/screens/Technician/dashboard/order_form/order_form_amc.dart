...
class OrderAMCScreen extends StatefulWidget {
  const OrderAMCScreen({super.key});

  @override
  State<OrderAMCScreen> createState() => _OrderAMCScreenState();
}

class _OrderAMCScreenState extends State<OrderAMCScreen> {
  double totalAmount = 3500.0, finalAmount = 0.0, finalPrice = 0.0;
  int? sliding = 0;
  String? selectedval = '';
  var bytes;
                                ...
                                children: [
                                  ...
                                  AddRemoveRateButtons(
                                    onAddButtonClick: () {
                                      ...
                                      var amt =
                                          (finalAmount * int.parse(tmpValue)) /
                                              100;
